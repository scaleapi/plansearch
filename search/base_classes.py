...
class SearchModel(BaseModel, ABC):
    def __init__(self, model_name: str, experiment_directory: str = None, cache_file: str = None):
        ...
        self.querier = LLMQuerier(os.path.join(self.experiment_directory, "queries"), cache_file=cache_file)
